                        ...
                        <table class="table align-items-center mb-0">
                            ...
                            <tbody>
                                ...
                                <td>
                                    ...
                                    <td>
                                        <p class="text-sm font-weight-bold mb-0"></p>{{$value->name}}
                                    </td>
                                    <td>
                                        <p class="text-sm font-weight-bold mb-0"></p>{{$value->contact_num}}
                                    </td>
                                    <td>
                                        ...
                                        <p class="text-sm font-weight-bold mb-0"></p>{{$value->title}}
                                    </td>
                                    <td>
